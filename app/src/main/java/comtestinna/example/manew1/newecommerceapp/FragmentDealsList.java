...
public class FragmentDealsList extends Fragment {

    public FragmentDealsList() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootview = inflater.inflate(R.layout.fragment_fragment_deals_list, container, false);
