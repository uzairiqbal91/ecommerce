...
public class TopSellerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_top_seller, container, false);
        ...
        RecyclerView recyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerViewTopSeller);
